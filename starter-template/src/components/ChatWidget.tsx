...
export const ChatWidget = () => {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      <div
        className={`fixed bottom-24 right-6 z-50 w-[calc(100vw-3rem)] sm:w-96 h-[calc(100vh-8rem)] sm:h-[32rem] max-h-[600px] glass-card rounded-2xl flex flex-col overflow-hidden transition-all duration-300 origin-bottom-right ${
